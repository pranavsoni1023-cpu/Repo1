...
export function ContactSection({ profile }: ContactSectionProps) {
  ...
  const [subject, setSubject] = useState('Business Operations & Analytics Inquiry');
  ...
  const handleSendEmail = (e: React.FormEvent) => {
    ...
    const mailtoUrl = `mailto:${profile.email}?subject=${encodeURIComponent(
      ...
      `Hi Pranav,\n\n${message}\n\nBest,\n${name || 'Recruiter / Engineering Manager'}`
    )}`;
              ...
              <form onSubmit={handleSendEmail} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="We came across your systems & AI engineering background and would love to chat about..."
